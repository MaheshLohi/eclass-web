...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
      ...
      _createClass(AdminStudentsComponent, [{
        ...
        value: function getDepartmentsAndSectionsList() {
          ...
          this._department.getDepartmentsAndSections().subscribe(function (response) {
            ...
            _this24.filterDataStatus = 1;
            _this24.departments = response.departments;
            _this24.semesters = response.inst_class;
          }, function (errorCode) {
            _this24._loader.hideLoader();

            _this24.filterDataStatus = errorCode;
          });
        }
      }, {
        key: "getStudentsData",
        ...
        value: function getStudents(data) {
          ...
          this._students.getStudents(data.department_id, data.inst_class_id).subscribe(function (response) {
            ...
            _this25.studentsDataStatus = 1;
            _this25.students = response;
          }, function (errorCode) {
            _this25._loader.hideLoader();

            _this25.studentsDataStatus = errorCode;
          });
        }
      }, {
        key: "showAddFeatureView",
        ...
        value: function addStudents() {
          ...
          this._students.addStudents(this.filterForm.value, this.addDataForm.value).subscribe(function (response) {
            ...
            _this26.showAddFeatureView(false);

            _this26._download.downloadAsCsv(response.data, _this26._constants.STUDENT_CSV_CONTENTS, 'students_list.csv');

            _this26.getStudents(_this26.filterForm.value);

            _this26._toaster.showSuccess(_this26._translate.instant("FEATURE_ADDED_SUCCESSFULLY", {
              value: _this26._translate.instant("STUDENTS")
            }));
          }, function () {
            _this26._loader.hideLoader();
          });
      ...
      _createClass(AdminSubjectsComponent, [{
        ...
        value: function getFaculties() {
          ...
          this.facultyService.getFaculties(data).subscribe(function (response) {
            _this27.loader.hideLoader();

            _this27.facultiesDataStatus = 1;
            _this27.faculties = response;
          }, function (errorCode) {
            _this27.loader.hideLoader();

            _this27.facultiesDataStatus = errorCode;
          });
        }
      }, {
        key: "resetDepartmentsAndSections",
        ...
        value: function getDepartmentsAndSectionsList() {
          ...
          this.departmentService.getDepartmentsAndSections().subscribe(function (response) {
            ...
            _this28.filterDataStatus = 1;
            _this28.departments = response.departments;
            _this28.semesters = response.inst_class;
          }, function (errorCode) {
            _this28.loader.hideLoader();

            _this28.filterDataStatus = errorCode;
          });
        }
      }, {
        key: "getSubjectsData",
        ...
        value: function getSubjects(data) {
          ...
          this.subjectsService.getSubjects(data.department_id, data.inst_class_id).subscribe(function (response) {
            ...
            _this29.subjectsDataStatus = 1;
            _this29.subjects = response;
          }, function (errorCode) {
            _this29.loader.hideLoader();

            _this29.subjectsDataStatus = errorCode;
          });
        }
      }, {
        key: "showAddFeatureView",
        ...
        value: function addSubjects() {
          ...
          this.subjectsService.addSubjects(this.addSubjectsForm.value).subscribe(function () {
            ...
            _this30.showAddFeatureView(false);

            if (_this30.filterDataStatus === 1) {
              _this30.getSubjectsData();
            } else {
              _this30.getDepartmentsAndSectionsList();
            }

            _this30.toaster.showSuccess(_this30.translate.instant("FEATURE_ADDED_SUCCESSFULLY", {
              value: _this30.translate.instant("SUBJECTS")
            }));
          }, function () {
            _this30.loader.hideLoader();
          });
        ...
        value: function assignFaculties() {
          ...
          this.subjectsService.assignFaculties(this.assignFacultyForm.value, this.selectedSubjectId).subscribe(function () {
            ...
            _this32.toaster.showSuccess(_this32.translate.instant("FACULTY_ASSIGNED_TO_SUBJECT_SUCCESSFULLY"));
          }, function () {
            _this32.loader.hideLoader();
          });
        }
  ...
  function srcAppAdminComponentsTopicTopicComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AdminTopicComponent = /*#__PURE__*/function () {
      function AdminTopicComponent(_constants, _translate, _toaster, _loader, _route, _router, _topic) {
        ...
        this._route.params.subscribe(function (params) {
          _this33.chapterId = params['chapterId'];
        });

        this._route.queryParams.subscribe(function (queryParams) {
          _this33.queryParams = queryParams;
        });
      ...
      _createClass(AdminTopicComponent, [{
        ...
        value: function getTopicsList() {
          ...
          this._topic.getTopicsList(this.chapterId).subscribe(function (response) {
            _this34._loader.hideLoader();

            _this34.topicsDataStatus = 1;
            _this34.chapterDetails = response;
            _this34.topics = response.chapter_details.data;

            if (_this34.queryParams.topicId) {
              var index = lodash__WEBPACK_IMPORTED_MODULE_5__["findIndex"](_this34.topics, {
                id: parseInt(_this34.queryParams.topicId)
              });

              _this34.prepareVimeoPlayer(index > -1 ? _this34.topics[index] : _this34.topics[0]);
            } else {
              _this34.prepareVimeoPlayer(_this34.topics[0]);
            }
          }, function (errorCode) {
            _this34._loader.hideLoader();

            _this34.topicsDataStatus = errorCode;
          });
        }
      }, {
        ...
        value: function updateTopic() {
          ...
          this._topic.updateTopic(this.editTopicForm.value).subscribe(function () {
            ...
            _this35.getTopicsList();

            _this35._toaster.showSuccess(_this35._translate.instant("FEATURE_UPDATED_SUCCESSFULLY", {
              value: _this35._translate.instant("TOPIC")
            }));
          }, function () {
            _this35._loader.hideLoader();
          });
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _adminComponents_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! @adminComponents/dashboard/dashboard.component */
    "./src/app/admin/components/dashboard/dashboard.component.ts");
    /* harmony import */


    var _adminComponents_faculties_faculties_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! @adminComponents/faculties/faculties.component */
    "./src/app/admin/components/faculties/faculties.component.ts");
    /* harmony import */


    var _adminComponents_students_students_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! @adminComponents/students/students.component */
    "./src/app/admin/components/students/students.component.ts");
    /* harmony import */


    var _adminComponents_department_department_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! @adminComponents/department/department.component */
    "./src/app/admin/components/department/department.component.ts");
    /* harmony import */


    var _adminComponents_subjects_subjects_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! @adminComponents/subjects/subjects.component */
    "./src/app/admin/components/subjects/subjects.component.ts");
    /* harmony import */


    var _adminComponents_chapter_chapter_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! @adminComponents/chapter/chapter.component */
    "./src/app/admin/components/chapter/chapter.component.ts");
    /* harmony import */


    var _adminComponents_faq_faq_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! @adminComponents/faq/faq.component */
    "./src/app/admin/components/faq/faq.component.ts");
    /* harmony import */


    var _adminComponents_topic_topic_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! @adminComponents/topic/topic.component */
    "./src/app/admin/components/topic/topic.component.ts");
    /* harmony import */


    var _adminComponents_examination_examination_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! @adminComponents/examination/examination.component */
    "./src/app/admin/components/examination/examination.component.ts");
    /* harmony import */


    var _studentComponents_subject_subject_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! @studentComponents/subject/subject.component */
    "./src/app/student/components/subject/subject.component.ts");
    /* harmony import */


    var _studentComponents_topic_topic_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! @studentComponents/topic/topic.component */
    "./src/app/student/components/topic/topic.component.ts");
    /* harmony import */


    var _studentComponents_content_content_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! @studentComponents/content/content.component */
    "./src/app/student/components/content/content.component.ts");
    /* harmony import */


    var _studentComponents_wishlist_wishlist_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! @studentComponents/wishlist/wishlist.component */
    "./src/app/student/components/wishlist/wishlist.component.ts");
    /* harmony import */


    var _studentComponents_feedback_feedback_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! @studentComponents/feedback/feedback.component */
    "./src/app/student/components/feedback/feedback.component.ts");
    /* harmony import */


    var _studentComponents_help_help_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! @studentComponents/help/help.component */
    "./src/app/student/components/help/help.component.ts");
    /* harmony import */


    var _studentComponents_search_search_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    /*! @studentComponents/search/search.component */
    "./src/app/student/components/search/search.component.ts");
    /* harmony import */


    var _studentComponents_profile_profile_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
    /*! @studentComponents/profile/profile.component */
    "./src/app/student/components/profile/profile.component.ts");
    /* harmony import */


    var _app_student_components_profile_create_profile_create_profile_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
    ...
    var _facultyComponents_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
    /*! @facultyComponents/dashboard/dashboard.component */
    "./src/app/faculty/components/dashboard/dashboard.component.ts");
    /* harmony import */


    var _facultyComponents_subjects_subjects_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
    /*! @facultyComponents/subjects/subjects.component */
    "./src/app/faculty/components/subjects/subjects.component.ts");
    /* harmony import */


    var _facultyComponents_questions_questions_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
    ...
    var routes = [{
      ...
      component: _adminComponents_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_9__["AdminDashboardComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'admin/faculties',
      component: _adminComponents_faculties_faculties_component__WEBPACK_IMPORTED_MODULE_10__["AdminFacultiesComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'admin/students',
      component: _adminComponents_students_students_component__WEBPACK_IMPORTED_MODULE_11__["AdminStudentsComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'admin/departments',
      component: _adminComponents_department_department_component__WEBPACK_IMPORTED_MODULE_12__["AdminDepartmentComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'admin/subjects',
      component: _adminComponents_subjects_subjects_component__WEBPACK_IMPORTED_MODULE_13__["AdminSubjectsComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'admin/chapters',
      component: _adminComponents_chapter_chapter_component__WEBPACK_IMPORTED_MODULE_14__["AdminChapterComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'admin/examination',
      component: _adminComponents_examination_examination_component__WEBPACK_IMPORTED_MODULE_17__["AdminExaminationComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'admin/faqs/:chapterId',
      component: _adminComponents_faq_faq_component__WEBPACK_IMPORTED_MODULE_15__["AdminFaqComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'admin/topics/:chapterId',
      component: _adminComponents_topic_topic_component__WEBPACK_IMPORTED_MODULE_16__["AdminTopicComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'student/home',
      component: _studentComponents_subject_subject_component__WEBPACK_IMPORTED_MODULE_18__["StudentSubjectComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'student/contents/:subjectId',
      component: _studentComponents_content_content_component__WEBPACK_IMPORTED_MODULE_20__["StudentContentComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'student/topics/:chapterId',
      component: _studentComponents_topic_topic_component__WEBPACK_IMPORTED_MODULE_19__["StudentTopicComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      ...
      component: _studentComponents_wishlist_wishlist_component__WEBPACK_IMPORTED_MODULE_21__["StudentWishlistComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'student/feedback',
      component: _studentComponents_feedback_feedback_component__WEBPACK_IMPORTED_MODULE_22__["StudentFeedbackComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'student/help',
      component: _studentComponents_help_help_component__WEBPACK_IMPORTED_MODULE_23__["StudentHelpComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'student/search',
      component: _studentComponents_search_search_component__WEBPACK_IMPORTED_MODULE_24__["StudentSearchComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'student/profile',
      component: _studentComponents_profile_profile_component__WEBPACK_IMPORTED_MODULE_25__["StudentProfileComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'student/create-profile',
      component: _app_student_components_profile_create_profile_create_profile_component__WEBPACK_IMPORTED_MODULE_26__["StudentCreateProfileComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'faculty/dashboard',
      component: _facultyComponents_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_27__["FacultyDashboardComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'faculty/subjects',
      component: _facultyComponents_subjects_subjects_component__WEBPACK_IMPORTED_MODULE_28__["FacultySubjectsComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: 'faculty/questions/:subjectId',
      component: _facultyComponents_questions_questions_component__WEBPACK_IMPORTED_MODULE_29__["FacultyQuestionsComponent"],
      canActivate: [src_app_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      path: '**',
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _facultyComponents_questions_questions_component__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(
    /*! @facultyComponents/questions/questions.component */
    "./src/app/faculty/components/questions/questions.component.ts");
    /* harmony import */


    var _studentComponents_list_error_list_error_component__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(
    /*! @studentComponents/list-error/list-error.component */
    "./src/app/student/components/list-error/list-error.component.ts");
    /* harmony import */


    var _facultyComponents_list_error_list_error_component__WEBPACK_IMPORTED_MODULE_56__ = __webpack_require__(
    /*! @facultyComponents/list-error/list-error.component */
    "./src/app/faculty/components/list-error/list-error.component.ts");
    /* harmony import */


    var _superAdminComponents_list_error_list_error_component__WEBPACK_IMPORTED_MODULE_57__ = __webpack_require__(
    /*! @superAdminComponents/list-error/list-error.component */
    "./src/app/superAdmin/components/list-error/list-error.component.ts");
    /* harmony import */


    var _adminComponents_list_error_list_error_component__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(
    /*! @adminComponents/list-error/list-error.component */
    "./src/app/admin/components/list-error/list-error.component.ts");
    /* harmony import */


    var _app_student_components_profile_create_profile_create_profile_component__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(
    /*! @app/student/components/profile/create-profile/create-profile.component */
    "./src/app/student/components/profile/create-profile/create-profile.component.ts");
    /* harmony import */


    var _studentComponents_recent_videos_recent_videos_component__WEBPACK_IMPORTED_MODULE_60__ = __webpack_require__(
  ...
  function srcAppConstantsTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Constants = function Constants() {
      ...
      this.DOMAIN_URL = 'http://143.110.188.198/';
      ...
      this.EXAM_PAPER_DELETE_URL = this.ADMIN_URL + 'examination/'; //students API
  ...
  function srcAppFacultyComponentsQuestionsQuestionsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FacultyQuestionsComponent = /*#__PURE__*/function () {
      function FacultyQuestionsComponent(_miscellaneous, _loader, _route, _toaster, _translate, _question) {
        ...
        this._route.params.subscribe(function (params) {
          _this36.subjectId = params['subjectId'];
        });
      }
      ...
      _createClass(FacultyQuestionsComponent, [{
        ...
        value: function getQuestionsList() {
          ...
          this._question.getQuestionsList(this.subjectId).subscribe(function (response) {
            ...
            _this37.questionsListStatus = 1;
            _this37.questionsList = response;
          }, function (errorStatus) {
            _this37.questionsListStatus = errorStatus;
        ...
        value: function submitReplay(question) {
          ...
          this._question.submitReplay(question).subscribe(function () {
            _this38.getQuestionsList();

            _this38._loader.hideLoader();

            _this38._toaster.showSuccess(_this38._translate.instant("FEATURE_ADDED_SUCCESSFULLY", {
              value: _this38._translate.instant("REPLAY")
            }));
          }, function () {
            _this38._loader.hideLoader();
          });
      ...
      _createClass(FacultySubjectsComponent, [{
        ...
        value: function getFacultySubjects() {
          ...
          this._subjects.getSubjectsList().subscribe(function (response) {
            ...
            _this39.subjectsListStatus = 1;
            _this39.subjectsList = response;
          }, function (errorStatus) {
            _this39.subjectsListStatus = errorStatus;
  ...
  function srcAppSharedComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(_router, _loader, _login) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function getUserDetails() {
          ...
          this._login.getUserDetails().subscribe(function (response) {
            ...
            _this41.navigateToDashboard(response.type);
          }, function () {
            _this41._loader.hideLoader();
          });
        }
      ...
      _createClass(HttpConfigInterceptor, [{
        ...
        value: function intercept(request, next) {
          ...
          return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (event) {
            ...
            _this42._miscellaneous.handle(error);
      ...
      _createClass(LoginService, [{
        ...
        value: function doLogin(loginData) {
          ...
          return this._http.post(this._constants.LOGIN_URL, loginData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            if (response && response.token) {
              _this43._storage.setData('Authorization', response);
        ...
        value: function getUserDetails() {
          ...
          return this._http.get(this._constants.USER_DETAILS_URL).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            if (response && response.data) {
              _this44._storage.setData('userDetails', response.data);
      ...
      _createClass(StudentChapterComponent, [{
        ...
        value: function getChaptersList() {
          ...
          this._chapter.getChaptersList(this.subjectId).subscribe(function (response) {
            ...
            _this47.chaptersDataStatus = 1;
            _this47.chapters = response;
          }, function (errorCode) {
            _this47._loader.hideLoader();

            _this47.chaptersDataStatus = errorCode;
          });
        }
      }, {
        key: "navigateToTopics",
  ...
  function srcAppStudentComponentsContentContentComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var StudentContentComponent = /*#__PURE__*/function () {
      function StudentContentComponent(_constants, _download, _miscellaneous, _loader, _route, _router, _subject) {
        ...
        this._route.params.subscribe(function (params) {
          _this48.subjectId = params['subjectId'];
        });

        this._route.queryParams.subscribe(function (queryParams) {
          _this48.contentType = parseInt(queryParams.contentType);
        });
      }
      ...
      _createClass(StudentContentComponent, [{
        ...
        value: function getSubjectDetails() {
          ...
          this._subject.getSubjectDetails(this.subjectId).subscribe(function (response) {
            _this49._loader.hideLoader();

            _this49.subjectDetailsDataStatus = 1;
            _this49.subjectDetails = response;
          }, function (errorCode) {
            _this49._loader.hideLoader();

            _this49.subjectDetailsDataStatus = errorCode;
          });
        }
      }, {
      ...
      _createClass(StudentExaminationComponent, [{
        ...
        value: function getExamsList() {
          ...
          this._examination.getExamsList(this.subjectId).subscribe(function (response) {
            ...
            _this50.examDataStatus = 1;
            _this50.examsList = response;
          }, function (errorCode) {
            _this50._loader.hideLoader();

            _this50.examDataStatus = errorCode;
          });
        }
      }]);
      ...
      _createClass(StudentNavbarComponent, [{
        ...
        value: function getSemestersList() {
          ...
          this._semester.getSemestersList().subscribe(function (response) {
            ...
            _this52.semestersDataStatus = 1;
            _this52.semesters = response.inst_class;

            _this52.renderSemestersList();
          }, function () {
            _this52._loader.hideLoader();

            _this52.semestersDataStatus = 0;
          });
        }
      }, {
      ...
      _createClass(StudentCreateProfileComponent, [{
        ...
        value: function getProfileDetails(status) {
          ...
          this._login.getUserDetails().subscribe(function (response) {
            ...
            _this53.profileDetailsStatus = 1;
            _this53.profileDetails = response;

            _this53.initiateProfileForm();

            if (status) {
              _this53._router.navigate(['/student/home']);
            }
          }, function (errorCode) {
            _this53._loader.hideLoader();

            _this53.profileDetailsStatus = errorCode;
          });
        }
      }, {
        key: "resetSemestersList",
        ...
        value: function getSemestersList() {
          ...
          this._semester.getSemestersList().subscribe(function (response) {
            ...
            _this54.semestersDataStatus = 1;
            _this54.semesters = response.inst_class;
          }, function () {
            _this54._loader.hideLoader();

            _this54.semestersDataStatus = 0;
          });
        }
      }, {
        ...
        value: function sendOTP() {
          ...
          this._profile.sendOTP(this.createProfileForm2.value).subscribe(function () {
            ...
            _this55._toaster.showSuccess(_this55._translate.instant("OTP_SENT_SUCCESSFULLY"));
          }, function () {
            _this55._loader.hideLoader();
          });
        }
        ...
        value: function verifyOTP() {
          ...
          this._profile.verifyOTP(this.createProfileForm2.value).subscribe(function () {
            _this56._loader.hideLoader();

            _this56.createProfile();
          }, function () {
            _this56._loader.hideLoader();
          });
        }
        ...
        value: function createProfile() {
          ...
          this._profile.createProfile(this.createProfileForm1.value, this.createProfileForm2.value).subscribe(function () {
            ...
            _this57._alert.showSuccess(_this57._translate.instant('PROFILE_CREATED_SUCCESSFULLY'), _this57._translate.instant('SUCCESS')).then(function () {
              _this57.getProfileDetails(1);
            });
          }, function () {
            _this57._loader.hideLoader();
          });
      ...
      _createClass(StudentProfileComponent, [{
        ...
        value: function getProfileDetails() {
          ...
          this.loginService.getUserDetails().subscribe(function (response) {
            _this58.loader.hideLoader();

            _this58.profileDetailsStatus = 1;
            _this58.profileDetails = response;
          }, function (errorCode) {
            _this58.loader.hideLoader();

            _this58.profileDetailsStatus = errorCode;
          });
        }
      }, {
        ...
        value: function updateProfile() {
          ...
          this.studentProfileService.updateProfile(this.editProfileForm.value).subscribe(function () {
            ...
            _this59.getProfileDetails();

            _this59.loader.hideLoader();

            _this59._storage.deleteData("selected_semester");

            _this59.toaster.showSuccess(_this59.translate.instant("FEATURE_UPDATED_SUCCESSFULLY", {
              value: _this59.translate.instant("PROFILE")
            }));
          }, function () {
            _this59.loader.hideLoader();
          });
        ...
        value: function getSemestersList() {
          ...
          this._semester.getSemestersList().subscribe(function (response) {
            _this60.loader.hideLoader();

            _this60.semestersDataStatus = 1;
            _this60.semesters = response.inst_class;
          }, function () {
            _this60.loader.hideLoader();

            _this60.semestersDataStatus = 0;
          });
        }
      }]);
      ...
      _createClass(StudentQuestionsComponent, [{
        ...
        value: function getQuestionsList() {
          ...
          this._question.getQuestionsList(this.topicId).subscribe(function (response) {
            ...
            _this61.questionsDataStatus = 1;
            _this61.questions = response.reverse();
          }, function () {
            _this61._loader.hideLoader();

            _this61.questionsDataStatus = 0;
          });
        }
      }, {
        key: "disableAddFeatureForm",
        ...
        value: function addQuestion() {
          ...
          this._question.addQuestion(this.addDataForm.value, this.topicId).subscribe(function () {
            ...
            _this62.getQuestionsList();

            _this62.addDataForm.reset();

            _this62._toaster.showSuccess(_this62._translate.instant("FEATURE_ADDED_SUCCESSFULLY", {
              value: _this62._translate.instant("QUESTION")
            }));
          }, function () {
            _this62._loader.hideLoader();
          });
      ...
      _createClass(StudentRecentVideosComponent, [{
        ...
        value: function getRecentVideosList() {
          ...
          this._recentVideos.getRecentVideosList().subscribe(function (response) {
            ...
            _this63.recentVideosDataStatus = 1;
            _this63.recentVideos = response;
          }, function (errorCode) {
            _this63._loader.hideLoader();

            _this63.recentVideosDataStatus = errorCode;
          });
        }
      }, {
        key: "navigateToTopics",
  ...
  function srcAppStudentComponentsSearchSearchComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var StudentSearchComponent = /*#__PURE__*/function () {
      function StudentSearchComponent(_constants, _miscellaneous, _route, _router, _loader, _search) {
        ...
        this._route.queryParams.subscribe(function (queryParams) {
          _this64.searchString = queryParams.searchString;
        });
      }
        ...
        value: function getSearchResults() {
          ...
          if (this.searchString) {
            ...
            this._search.getSearchResultsList(this.searchString).subscribe(function (response) {
              ...
              _this65.searchResultsDataStatus = 1;
              _this65.searchResults = response;
            }, function (errorCode) {
              _this65._loader.hideLoader();

              _this65.searchResultsDataStatus = errorCode;
            });
          }
        }
      }, {
  ...
  function srcAppStudentComponentsSubjectSubjectComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var StudentSubjectComponent = /*#__PURE__*/function () {
      function StudentSubjectComponent(_constants, _download, _miscellaneous, _loader, _router, _subjects) {
      ...
      _createClass(StudentSubjectComponent, [{
        ...
        value: function getSubjects() {
          ...
          this._subjects.getSubjectsList(this.selectedSemester).subscribe(function (response) {
            ...
            _this66.subjectsDataStatus = 1;
            _this66.subjects = response[0].subjects.data;
          }, function (errorCode) {
            _this66._loader.hideLoader();

            _this66.subjectsDataStatus = errorCode;
          });
        }
      }, {
        key: "onSubjectSelection",
  ...
  function srcAppStudentComponentsTopicTopicComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var StudentTopicComponent = /*#__PURE__*/function () {
      function StudentTopicComponent(_constants, _download, _translate, _toaster, _loader, _route, _router, _topic, _wishlist) {
        ...
        this._route.params.subscribe(function (params) {
          _this67.chapterId = params['chapterId'];
        });

        this._route.queryParams.subscribe(function (queryParams) {
          _this67.queryParams = queryParams;
        });
      }
      ...
      _createClass(StudentTopicComponent, [{
        ...
        value: function getTopicsList() {
          ...
          this._topic.getTopicsList(this.chapterId).subscribe(function (response) {
            _this68._loader.hideLoader();

            _this68.topicsDataStatus = 1;
            _this68.chapterDetails = response;
            _this68.topics = response.chapter_details.data;

            if (_this68.queryParams.topicId) {
              var index = lodash__WEBPACK_IMPORTED_MODULE_4__["findIndex"](_this68.topics, {
                id: parseInt(_this68.queryParams.topicId)
              });

              _this68.prepareVimeoPlayer(index > -1 ? _this68.topics[index] : _this68.topics[0]);
            } else {
              _this68.prepareVimeoPlayer(_this68.topics[0]);
            }
          }, function (errorCode) {
            _this68._loader.hideLoader();

            _this68.topicsDataStatus = errorCode;
          });
        }
      }, {
        key: "prepareVimeoPlayer",
        ...
        value: function updateTopicWishlist(status) {
          ...
          this._wishlist.updateTopicWishlist(this.selectedTopic).subscribe(function () {
            _this69._loader.hideLoader();

            _this69.selectedTopic.is_wishlist = status;

            _this69._toaster.showSuccess(_this69._translate.instant("FEATURE_UPDATED_SUCCESSFULLY", {
              value: _this69._translate.instant("WISHLIST")
            }));
          }, function () {
            _this69._loader.hideLoader();
          });
      ...
      _createClass(StudentWishlistComponent, [{
        ...
        value: function getWishlistDetails() {
          ...
          this._wishlist.getWishlistDetails().subscribe(function (response) {
            _this70._loader.hideLoader();

            _this70.wishlistDataStatus = 1;
            _this70.wishlists = response;
          }, function (errorCode) {
            _this70._loader.hideLoader();

            _this70.wishlistDataStatus = errorCode;
          });
        }
      }, {
        key: "navigateToTopics",
        ...
        value: function updateTopicWishlist(selectedTopic, event) {
          ...
          this._wishlist.updateTopicWishlist(data).subscribe(function () {
            _this71._loader.hideLoader();

            _this71.getWishlistDetails();

            _this71._toaster.showSuccess(_this71._translate.instant("FEATURE_UPDATED_SUCCESSFULLY", {
              value: _this71._translate.instant("WISHLIST")
            }));
          }, function () {
            _this71._loader.hideLoader();
          });
      ...
      _createClass(SuperAdminAdminsComponent, [{
        ...
        value: function getAdmins() {
          ...
          this._admin.getAdmins().subscribe(function (response) {
            ...
            _this72.adminDataStatus = 1;
            _this72.admins = response;
          }, function (errorCode) {
            _this72._loader.hideLoader();

            _this72.adminDataStatus = errorCode;
          });
        }
      }, {
        key: "resetInstitutes",
        ...
        value: function getInstitutes() {
          ...
          this._institute.getInstitutes().subscribe(function (response) {
            _this73._loader.hideLoader();

            _this73.instituteDataStatus = 1;
            _this73.institutes = response;
          }, function (errorCode) {
            _this73._loader.hideLoader();

            _this73.instituteDataStatus = errorCode;
          });
        }
      }, {
        key: "showAddFeatureView",
        ...
        value: function addAdmin() {
          ...
          this._admin.addAdmin(this.addAdminForm.value).subscribe(function () {
            ...
            _this74.showAddFeatureView(false);

            _this74.getAdmins();

            _this74._toaster.showSuccess(_this74._translate.instant("FEATURE_ADDED_SUCCESSFULLY", {
              value: _this74._translate.instant("ADMIN")
            }));
          }, function () {
            _this74._loader.hideLoader();
          });
        ...
        value: function updateAdmin() {
          ...
          this._admin.updateAdmin(this.editForm.value).subscribe(function () {
            ...
            _this75._toaster.showSuccess(_this75._translate.instant("FEATURE_UPDATED_SUCCESSFULLY", {
              value: _this75._translate.instant("ADMIN")
            }));
          }, function () {
            _this75._loader.hideLoader();
          });
        ...
        value: function updateStatus(admin) {
          ...
          this._admin.updateStatus(admin).subscribe(function () {
            ...
            _this76._toaster.showSuccess(_this76._translate.instant("FEATURE_UPDATED_SUCCESSFULLY", {
              value: _this76._translate.instant("ADMIN_STATUS")
            }));
          }, function () {
            _this76._loader.hideLoader();
          });
      ...
      _createClass(SuperAdminDashboardComponent, [{
        ...
        value: function getDashboardData() {
          ...
          this._dashboard.getDashboardData().subscribe(function (response) {
            ...
            _this77.dashboardDataStatus = 1;
            _this77.dashboardData = response;

            _this77.prepareDashboardReportCards();
          }, function (errorCode) {
            _this77._loader.hideLoader();

            _this77.dashboardDataStatus = errorCode;
          });
        }
      }, {
        key: "prepareDashboardReportCards",
      ...
      _createClass(SuperAdminInstitutesComponent, [{
        ...
        value: function getInstitutes() {
          ...
          this._institute.getInstitutes().subscribe(function (response) {
            ...
            _this78.instituteDataStatus = 1;
            _this78.institutes = response;
          }, function (errorCode) {
            _this78._loader.hideLoader();

            _this78.instituteDataStatus = errorCode;
          });
        }
      }, {
        key: "showAddFeatureView",
        ...
        value: function addInstitute() {
          ...
          this._institute.addInstitute(this.addDataForm.value).subscribe(function () {
            ...
            _this79.showAddFeatureView(false);

            _this79.getInstitutes();

            _this79._toaster.showSuccess(_this79._translate.instant("FEATURE_ADDED_SUCCESSFULLY", {
              value: _this79._translate.instant("INSTITUTE")
            }));
          }, function () {
            _this79._loader.hideLoader();
          });
        ...
        value: function updateStatus(institute) {
          ...
          this._institute.updateStatus(institute).subscribe(function () {
            ...
            _this80._toaster.showSuccess(_this80._translate.instant("FEATURE_UPDATED_SUCCESSFULLY", {
              value: _this80._translate.instant("INSTITUTE_STATUS")
            }));
          }, function () {
            _this80._loader.hideLoader();
          });
        ...
        value: function updateInstitute() {
          ...
          this._institute.updateInstitute(this.editDataForm.value).subscribe(function () {
            ...
            _this81.getInstitutes();

            _this81._loader.hideLoader();

            _this81._toaster.showSuccess(_this81._translate.instant("FEATURE_UPDATED_SUCCESSFULLY", {
              value: _this81._translate.instant("INSTITUTE")
            }));
          }, function () {
            _this81._loader.hideLoader();
          });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/mahesh/workspace/rewind_web/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
